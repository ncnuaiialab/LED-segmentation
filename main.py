...
def square_extractor(img):
    ...
    ### 連通塊
    ### cc_box => 連通區域外接矩形的x, y, width, height, area
...
if __name__=='__main__':
    for file in os.listdir('imgs'):
        ...
        for wire_id in range(1, 10):
            ...
            # if maxb>240 and maxg>240 and maxr>240:
                # print('正常發亮中')
            # elif maxb>240 and maxr<50:
                # print('')
        
        
        '''
        test=test_board.copy()
        test[np.where(template_board!=0)]=np.array([0,255,0], dtype='uint8')
